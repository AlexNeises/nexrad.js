...
###
@api {post} /v1/nexrad/radial All Data
@apiGroup Radial
@apiVersion 1.0.0
...
###
@api {post} /v1/nexrad/radial/headers Header Data
@apiGroup Radial
@apiVersion 1.0.0
@apiParam {Binary} file NEXRAD-specific binary data file
...
###
app.post "#{baseurl}/radial/headers", (req, res, next) ->
	if not fs.existsSync 'tmp_uploads/'
		fs.mkdirSync 'tmp_uploads/'
	if req.busboy?
		req.pipe req.busboy
...
###
@api {post} /v1/nexrad/radial/description Description Data
@apiGroup Radial
@apiVersion 1.0.0
@apiParam {Binary} file NEXRAD-specific binary data file
...
###
app.post "#{baseurl}/radial/description", (req, res, next) ->
	if not fs.existsSync 'tmp_uploads/'
		fs.mkdirSync 'tmp_uploads/'
	if req.busboy?
		req.pipe req.busboy
...
###
@api {post} /v1/nexrad/radial/symbology Symbology Data
@apiGroup Radial
@apiVersion 1.0.0
@apiParam {Binary} file NEXRAD-specific binary data file
...
###
app.post "#{baseurl}/radial/symbology", (req, res, next) ->
	if not fs.existsSync 'tmp_uploads/'
		fs.mkdirSync 'tmp_uploads/'
	if req.busboy?
		req.pipe req.busboy
...
###
@api {post} /v1/nexrad/radial/graphic_alpha Graphic Alphanumeric Data
@apiGroup Radial
@apiVersion 1.0.0
@apiParam {Binary} file NEXRAD-specific binary data file
...
###
app.post "#{baseurl}/radial/graphic_alpha", (req, res, next) ->
	if not fs.existsSync 'tmp_uploads/'
		fs.mkdirSync 'tmp_uploads/'
	if req.busboy?
		req.pipe req.busboy
